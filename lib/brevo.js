...
<html lang="es">
  <body style="margin:0;background:#f2f0e9;color:#161714;font-family:Arial,Helvetica,sans-serif;">
    <div style="max-width:640px;margin:0 auto;padding:40px 24px;">
      ...
      <p>Si necesitas ayuda, responde a este correo o escribe a <a href="mailto:contacto@maderasdelmundo.es">contacto@maderasdelmundo.es</a>.</p>
