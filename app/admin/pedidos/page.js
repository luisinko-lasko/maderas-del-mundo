    ...
    <main className="admin-page">
      ...
      <section className="admin-main">
        <div className="admin-top">
          <div>
            <div className="page-eyebrow">Administración / Pedidos</div>
            <h1>Pedidos</h1>
          </div>
        </div>
        ...
        <div className="collection-list">
          ...
          {pedidosFiltrados.map(pedido => {
            ...
            return (
              <div className="collection-row" key={pedido.id}>
                <div>
                  <strong>
                  ...
                  <em>{formatearFecha(pedido.created_at)}</em>
                  <em>{pedido.email || pedido.email_entrega || 'Sin email'}</em>
                </div>
                ...
                <div>
                  ...
                  {(pedido.codigo_postal_entrega || pedido.poblacion_entrega) && (
                    <div>
                  ...
                  {pedido.provincia_entrega && (
                    <div>{pedido.provincia_entrega}</div>
                  )}
                </div>
